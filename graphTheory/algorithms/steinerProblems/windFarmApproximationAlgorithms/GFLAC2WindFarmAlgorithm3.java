 ...
 *
 */
public class GFLAC2WindFarmAlgorithm3 extends WindFarmApproximationAlgorithm {
	...
	private Comparator<Arc> getArcsComparator() {
		return (o1, o2) -> {
            if (o1 == null)
                ...
                int comp1 = i1.compareTo(i2);
                if (comp1 != 0)
                    return comp1;
                comp1 = o1.getInput().compareTo(o2.getInput());
                if (comp1 != 0)
                    return comp1;
...
//				System.out.println(a);
	...
	private LinkedList<Arc> getConflictedArcs(LinkedList<Arc> arcs){
		LinkedList<Arc> conflictedArcs = arcs.stream().filter(a -> findConflict(a)).collect(Collectors.toCollection(LinkedList::new));
